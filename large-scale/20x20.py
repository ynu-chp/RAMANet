...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str, default='data/20x20')
    ...
    parser.add_argument('--m_items', type=int, default=20)
    parser.add_argument('--menu_size', type=int, default=64)
